...
public class MyLinkedList2 <E>
{
     ...
     */
    public void agregarAlFinal(E valor){
     ...
     * @param valor a agregar.
     */   
    public void agregarAlInicio(E valor){
        // Define un nuevo nodo.
        Nodo nuevo = new Nodo();
        // Agrega al valor al nodo.
        nuevo.setValor(valor);
     ...
     */
    public void insertarPorReferencia(int referencia, E valor){
        // Define un nuevo nodo.
        Nodo nuevo = new Nodo();
        // Agrega al valor al nodo.
        nuevo.setValor(valor);
        ...
        if (!esVacia()) {
            ...
            if (buscar(referencia)) {
                ...
                while ((Integer)aux.getValor() != referencia) {
                    aux = aux.getSiguiente();
                }
     ...
     */
    public void insrtarPorPosicion(int posicion, E valor){
     ...
     * @throws Exception
     */
    public E getValor(int posicion) throws Exception{
        // Verifica si la posición ingresada se encuentre en el rango
        // >= 0 y < que el numero de elementos del la lista.
        if(posicion>=0 && posicion<tamanio){
    ...
    public boolean buscar(int referencia){
        ...
        while(aux != null && encontrado != true){
            ...
            if (referencia == (Integer)aux.getValor()){
    ...
    public int getPosicion(int referencia) throws Exception{
        ...
        if (buscar(referencia)) {
            ...
            while(referencia != (Integer)aux.getValor()){
     ...
     */
    public void editarPorReferencia(int referencia, E valor){
        // Consulta si el valor existe en la lista.
        if (buscar(referencia)) {
            // Crea ua copia de la lista.
            Nodo aux = inicio;
     ...
     * @param valor nuevo valor para el nodo.
     */
    public void editarPorPosicion(int posicion , E valor){
        // Verifica si la posición ingresada se encuentre en el rango
        // >= 0 y < que el numero de elementos del la lista.
        if(posicion>=0 && posicion<tamanio){
    ...
    public void removerPorReferencia(int referencia){
        ...
        if (buscar(referencia)) {
            ...
            if ((Integer)inicio.getValor() == referencia) {
                ...
                // Recorre la lista hasta llegar al nodo anterior 
                // al de referencia.
                while((Integer)aux.getSiguiente().getValor() != referencia){
                    aux = aux.getSiguiente();
                }
